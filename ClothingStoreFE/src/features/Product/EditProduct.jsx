...
import {fetchAdd, fetchUpdate} from "src/features/Product/productSlice";
...
const EditProduct = NiceModal.create(({data}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, {resetForm}) => {
      ...
      dispatch(fetchUpdate(dataFetch));
      modal.hide() ;
    },
  });
